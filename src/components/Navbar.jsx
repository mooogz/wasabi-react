  ...
  return (
    <header className="bg-[#87bd80] py-4 px-6">
        ...
        <nav className="mt-4 flex flex-col items-center sm:flex-row justify-center space-y-2 sm:space-y-0 sm:space-x-8 text-gray-900">
            <a href="/" className="px-2 py-1 hover:text-[#4c7a42] transition-colors duration-300">Home</a>
            <a href="/menu" className="px-2 py-1 hover:text-[#4c7a42] transition-colors duration-300">Menu</a>
